...
const Ticket = ({from,to,depTime,landTime,price,company,type,airplane}: Props) => {
  return (
    <div className="w-full bg-white rounded-xl flex border border-gray-300 font-iran shadow-md ">
      <div className="flex flex-col items-center space-y-3 py-10 px-4 border-r-gray-300 border-r justify-center">
        <div className="flex font-iran space-x-1 justify-center text-[#0077db]">
          ...
          <p className="font-bold text-xl tracking-widest">{price}</p>
        </div>
        <div>
        ...
        <div>
          <div className="flex space-y-3 flex-col items-end justify-end">
            <div className="flex font-iran flex-row-reverse justify-start text-gray-500 space-x-4 py-3">
              ...
              <h5 className="rounded-2xl bg-slate-50 px-2 ">{airplane}</h5>
            </div>
            <div className="flex items-center space-x-7">
              <div className="flex space-x-3  items-center">
                <h5 className="text-black font-bold text-2xl">{landTime[0]}:{landTime[1]}</h5>
              ...
              <div className="flex space-x-3 items-center">
                <h5 className="text-black font-bold text-2xl">{depTime[0]}:{depTime[1]}</h5>
